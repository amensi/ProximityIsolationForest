...
% #Lines 23-33 implement Lines 5-9 of Algorithm 1#
if strcmpi(param.crit,'R-1P') %Random criterion
    ...
    % #Lines 46-51 implement Lines 13-14 of Algorithm 1#
    [P1,P2]=ndgrid(1:N);
    protosIdx=[P1(:) P2(:)];
    ...
    %Test Evaluation
    % #Lines 55-76 implement Lines 15-24 of Algorithm 1#
    I=-Inf;
    for pp=1:length(protos)
        %Creation of the putative child nodes
        % #Lines 59-67 implement Lines 17-18 of Algorithm 1#
        ...
        I_tmp=EvaluateTest(train,tree,trleft,trright,param); % #Implements Lines 19-21 of Algorithm 1#
        % #Lines 70-74 Implement Lines 22-24 of Algorithm 1#
