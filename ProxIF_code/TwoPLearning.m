...
% #Lines 23-27 implement Lines 5-9 of Algorithm 2#
if strcmpi(param.crit,'R-2P') %Random criterion
    ...
    % #Lines 40-45 implement Lines 13-14 of Algorithm 2#
    [P1,P2]=ndgrid(1:N);
    protosIdx=[P1(:) P2(:)];
    ...
    %Test Evaluation
    % #Lines 49-70 implement Lines 15-24 of Algorithm 2#
    I=-Inf;
    for pp=1:length(protosL)
        %Creation of the putative child nodes
        % #Lines 52-61 implement Lines 17-18 of Algorithm 2#
        ...
        % #Lines 65-69 Implement Lines 22-24 of Algorithm 2#
